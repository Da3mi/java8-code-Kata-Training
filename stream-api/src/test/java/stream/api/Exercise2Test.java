...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void sortByAge() {
		...
		Function<Customer, Integer> getAtgeFunction= Customer::getAge;
		
        Stream<Integer> sortedAgeStream = customerList.stream().map(getAtgeFunction).sorted(comparator);
    ...
    public void top3RichCustomer() {
        ...
        Comparator<Customer> mostRichOrder = (o1,o2) -> o2.getBudget() - o1.getBudget();
        
        Stream<String> top3RichCustomerStream = customerList.stream().sorted(mostRichOrder).map(Customer::getName).limit(3);
